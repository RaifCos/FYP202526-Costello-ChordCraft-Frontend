...
NetworkInterface provides a interface for training and testing PyTorch models. To use the class, you first need to define a model structure in a subclass of chord_cnn_lstm.mir.nn.NetworkBehavior.
